...
void RobotControl(void) {
    ...
    if (settlegyro < SETTLETIME) {
        ...
        case 1:
            ...
            else if((color_distance_p<3) && (numpels_p > 25)){
                if (outside == 0){
                    path_mode = 3;
                }
            }
        ...
        case 2:
            ...
            //            }
            //
            //            avg = (int)((float)avg/20.0);
            //            for (i = 0; i<19; i++){
            //                pinkavg[19 - i] = pinkavg[19 - 1 - i];
            //            }
            //
            //            //            if (avg > 50)
            //            //    pink_tally++;
            ...
            //            //            pink_tally = 0;
            //
            //            if(((avg > 35) && (weed_centered == 0))||(color_lat == 1)){
            //                                if (color_lat == 0){
            //                                    timer_c = 0;
            //                                    color_lat = 1;
            //                                }
            ...
            //                                    color_lat = 0;
            //                                }
            //                //color_distance = ((0.000425195*objecty_b*objecty_b*objecty_b)+(0.074152963*objecty_b*objecty_b)+(4.686246680*objecty_b)+127.692244805)/12.0;
            //                color_vision_error = 0 - objectx_b;
            //                vref = 0;
            //                if(fabs(objectx_b) > 30){
            ...
            //                    pink_tally = 0;
            //                    dont_astar = 1;
            //                    //                    x_weed_world[weednum] = -color_distance*cos(ROBOTps.theta) + ROBOTps.x;
            //                    //                    y_weed_world[weednum] = color_distance*sin(ROBOTps.theta) + ROBOTps.y;
            ...
            if (((color_distance_b < 2) && (color_distance_b > 1.6)) || (dead_reckon ==1))
            {
                ...
                if (((color_distance_b < 2) && (color_distance_b >= 1.9))){
                    blue_dist = 1.9;
                    x_blue[blue_count] = ROBOTps.x + blue_dist*cos(ROBOTps.theta);
                    y_blue[blue_count] = ROBOTps.y + blue_dist*sin(ROBOTps.theta);
                }
                dead_reckon_timer++;
        ...
        if ((timecount%200)==0) {
            ...
            case 4:
                LCDPrintfLine(1,"Distance_p %.2f",color_distance_b);
                LCDPrintfLine(2,"B %d P %d",numpels_b, numpels_p);
                break;

            case 5:
                LCDPrintfLine(1,"xW %.1f yW %.1f",x_blue[0],y_blue[0]);
                LCDPrintfLine(2,"P %d T %d",avg, pink_tally);
                break;
