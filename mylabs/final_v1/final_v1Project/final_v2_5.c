...
void RobotControl(void) {
    ...
    if (settlegyro < SETTLETIME) {
        ...
        case 2:
            ...
            //                //                    x_blue[blue_count] = ROBOTps.x + 1.9*cos(ROBOTps.theta);
            //                //                    y_blue[blue_count] = ROBOTps.y + 1.9*sin(ROBOTps.theta);
            //                //                }
            //                if (((color_distance_b < 2) && (color_distance_b >= 1.9))){
            ...
            if (((color_distance_b < 2) && (color_distance_b > 1.6)) || (dead_reckon ==1))
            {
                if (((color_distance_b < 2) && (color_distance_b >= 1.9))){
                    blue_have = 0;
                    for (i = 0; i<5; i++){
                        if ((fabs(ROBOTps.x + 1.9*cos(ROBOTps.theta) - x_blue[i]) < 1) && (fabs(ROBOTps.y + 1.9*sin(ROBOTps.theta) - y_blue[i]) < 1)) {
                            blue_have = 1;
                            do_astar = 1;
                            path_mode = 1;
                            //avoid_b_timer = 0;
