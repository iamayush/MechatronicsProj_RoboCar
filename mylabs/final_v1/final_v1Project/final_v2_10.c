    ...
    while(1) {
        ...
        if ((tskcount%6)==0) {
            if (GET_LVDATA_TO_LINUX) {
                ...
                ptrshrdmem->DSPSend_size = sprintf(toLinuxstring,"%.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f %.1f",var1,var2,var3,var4,var5,var6,var7,var8,var9,var10,var11,var12,var13,var14);
...
#warn GP6.15 is also connected to CAMERA RESET This is a Bug in my board design Need to change Camera Reset to different IO.
    ...
    robotdest[4].x = -5;    robotdest[4].y = 11;
    robotdest[5].x = 5;    robotdest[5].y = 11;
...
void RobotControl(void) {
    ...
    if (settlegyro < SETTLETIME) {
        ...
        case 1:
            ...
            if((color_distance_b < 3) && (numpels_b > 35)){
        ...
        case 2:
            b_find_timer++;
            //            if ((b_find_timer < 2000) && (b_find_timer > 1700)){
            //                if(Fminladar < 700){
            //                    do_astar = 1;
            //                    path_mode = 1;
            //                    b_just_seen = 1;
        ...
        case 3:
            ...
            p_find_timer++;
            //            if ((p_find_timer < 2000) && (p_find_timer > 1700)){
            //                if(Fminladar < 700){
            //                    do_astar = 1;
            //                    path_mode = 1;
            //                    p_just_seen = 1;
