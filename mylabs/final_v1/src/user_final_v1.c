...
float var22 = -6;
//Obstacles
float var23 = -6; //x coordinate horizontal case
float var24 = -6; //y coordinate horizontal case
float var25 = -6; //x coordinate vertical case
float var26 = -7; //y coordinate vertical case
                ...
                for(i=0; i<57; i++){
                    if((obs_loc[i].sent == 0) && (obs_loc[i].found == 1)){
                        if(obs_loc[i].orient == 'h'){
                            var23 = (float)obs_loc[i].x;
                            var24 = (float)obs_loc[i].y;
                            var25 = -6.0;
                            var26 = -6.0;
                            obs_loc[i].sent = 1;
                            goto exit_for;
                            ...
                            var23 = -6.0;
                            var24 = -6.0;
                            var25 = (float)obs_loc[i].x;
                            var26 = (float)obs_loc[i].y;
                            obs_loc[i].sent = 1;
                            goto exit_for;
                        }
                    }
