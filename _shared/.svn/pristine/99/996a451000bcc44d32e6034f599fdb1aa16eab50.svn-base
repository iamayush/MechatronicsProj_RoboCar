...
NoError:
        ...
        PrintLine(1, "								<listOptionValue builtIn=""false"" value=""DSPBIOS_VERSION=5.42.02.10""/>")
        PrintLine(1, "								<listOptionValue builtIn=""false"" value=""OUTPUT_TYPE=bios5Application:rtscApplication:executable""/>")
        PrintLine(1, "							</option>")
        PrintLine(1, "							<option id=""com.ti.ccstudio.buildDefinitions.core.OPT_CODEGEN_VERSION.215843378"" superClass=""com.ti.ccstudio.buildDefinitions.core.OPT_CODEGEN_VERSION"" value=""6.2.11"" valueType=""string""/>")
        ...
        PrintLine(1, "									<listOptionValue builtIn=""false"" value=""&quot;${PROJECT_ROOT}/../../../_shared/mcbsp_com&quot;""/>")
        ...
        PrintLine(1, "<codegenToolVersion value=""6.2.11""/>")
        ...
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\*.cmd " & ProjectDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\DSPBIOS\PROJECTNAME.tcf " & Project_DSPBIOS_Dir & ProjectName & ".tcf")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\include\*.* " & Project_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\src\*.* " & Project_src_Dir)
        PrintLine(1, "move " & Project_src_Dir & "user_PROJECTNAME.c " & Project_src_Dir & "user_" & ProjectName & ".c")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\project\*.ccxml " & ProjectSubDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\project\.settings\*.* " & ProjectSub_settings_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\v110\DSP2833x_common\cmd\*.* " & Project_DSP2833x_common_cmd_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\v110\DSP2833x_common\include\*.* " & Project_DSP2833x_common_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\v110\DSP2833x_common\source\*.* " & Project_DSP2833x_common_source_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\v110\DSP2833x_headers\cmd\*.* " & Project_DSP2833x_headers_cmd_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\v110\DSP2833x_headers\include\*.* " & Project_DSP2833x_headers_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018F28335ProjectCreator\v110\DSP2833x_headers\source\*.* " & Project_DSP2833x_headers_source_Dir)
        PrintLine(1, Drive)
