...
NoError:
        ...
        PrintLine(1, "			<type>1</type>")
        PrintLine(1, "			<locationURI>PARENT-3-PROJECT_LOC/_shared/c67xmathlib_2_01_00_00/lib/c674xfastMath.lib</locationURI>")
        PrintLine(1, "		</link>")
        PrintLine(1, "		<link>")
        PrintLine(1, "			<name>evmomapl138_bsl.lib</name>")
        PrintLine(1, "			<type>1</type>")
        PrintLine(1, "			<locationURI>PARENT-3-PROJECT_LOC/_shared/bsl/lib/evmomapl138_bsl.lib</locationURI>")
        PrintLine(1, "		</link>")
        PrintLine(1, "		<link>")
        ...
        PrintLine(1, "							</option>")
        PrintLine(1, "							<option id=""com.ti.ccstudio.buildDefinitions.core.OPT_CODEGEN_VERSION.309112353"" superClass=""com.ti.ccstudio.buildDefinitions.core.OPT_CODEGEN_VERSION"" value=""7.4.22"" valueType=""string""/>")
        ...
        PrintLine(1, "									<listOptionValue builtIn=""false"" value=""&quot;${PROJECT_ROOT}/../../../_shared/bsl/inc&quot;""/>")
        PrintLine(1, "									<listOptionValue builtIn=""false"" value=""&quot;${PROJECT_ROOT}/..&quot;""/>")
        PrintLine(1, "									<listOptionValue builtIn=""false"" value=""&quot;${PROJECT_ROOT}/../../../_shared/c67xmathlib_2_01_00_00/inc&quot;""/>")
        PrintLine(1, "									<listOptionValue builtIn=""false"" value=""&quot;${PROJECT_ROOT}/../../../_shared/mcbsp_com&quot;""/>")
        PrintLine(1, "									<listOptionValue builtIn=""false"" value=""&quot;${PROJECT_ROOT}/../../../_shared/sharedmem_com&quot;""/>")
        ...
        PrintLine(1, "<codegenToolVersion value=""7.4.22""/>")
        ...
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018OptitrackOMAPL138ProjCreatorFiles\*.cmd " & ProjectDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018OptitrackOMAPL138ProjCreatorFiles\DSPBIOS\PROJECTNAME.tcf " & Project_DSPBIOS_Dir & ProjectName & ".tcf")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018OptitrackOMAPL138ProjCreatorFiles\include\*.* " & Project_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018OptitrackOMAPL138ProjCreatorFiles\PRUcode\*.* " & Project_PRUcode_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018OptitrackOMAPL138ProjCreatorFiles\src\*.* " & Project_src_Dir)
        PrintLine(1, "move " & Project_src_Dir & "user_PROJECTNAME.c " & Project_src_Dir & "user_" & ProjectName & ".c")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018OptitrackOMAPL138ProjCreatorFiles\project\*.ccxml " & ProjectSubDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\Spr2018OptitrackOMAPL138ProjCreatorFiles\project\.settings\*.* " & ProjectSub_settings_Dir)
        PrintLine(1, Drive)
