...
NoError:
        ...
        PrintLine(1, "		</link>")
        PrintLine(1, "		<link>")
        PrintLine(1, "			<name>user_PIFuncs.c</name>")
        PrintLine(1, "			<type>1</type>")
        PrintLine(1, "			<locationURI>PARENT-1-PROJECT_LOC/source/user_PIFuncs.c</locationURI>")
        PrintLine(1, "		</link>")
        PrintLine(1, "		<link>")
        ...
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\cmd\*.cmd " & Project_cmd_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\SYSBIOS\PROJECTNAME.cfg " & Project_SYSBIOS_Dir & ProjectName & ".cfg")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\include\*.* " & Project_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\source\*.* " & Project_source_Dir)
        PrintLine(1, "move " & Project_source_Dir & "user_PROJECTNAME.c " & Project_source_Dir & "user_" & ProjectName & ".c")
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\project\*.* " & ProjectSubDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\project\targetConfigs\*.* " & ProjectSub_targetConfigs_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\project\.settings\*.* " & ProjectSub_settings_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\v110\DSP2833x_common\cmd\*.* " & Project_DSP2833x_common_cmd_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\v110\DSP2833x_common\include\*.* " & Project_DSP2833x_common_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\v110\DSP2833x_common\source\*.* " & Project_DSP2833x_common_source_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\v110\DSP2833x_headers\cmd\*.* " & Project_DSP2833x_headers_cmd_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\v110\DSP2833x_headers\include\*.* " & Project_DSP2833x_headers_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\..\_shared\SYSBIOS_BETA\SYSBIOSF28335ProjectCreator\v110\DSP2833x_headers\source\*.* " & Project_DSP2833x_headers_source_Dir)
        PrintLine(1, Drive)
