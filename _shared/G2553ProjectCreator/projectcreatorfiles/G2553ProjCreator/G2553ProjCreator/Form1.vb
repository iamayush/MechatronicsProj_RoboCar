...
NoError:
        ...
        PrintLine(1, "								<option id=""com.ti.ccstudio.buildDefinitions.MSP430_4.0.compilerID.PRINTF_SUPPORT.911389106"" name=""Level of printf support required (--printf_support)"" superClass=""com.ti.ccstudio.buildDefinitions.MSP430_4.0.compilerID.PRINTF_SUPPORT"" value=""com.ti.ccstudio.buildDefinitions.MSP430_4.0.compilerID.PRINTF_SUPPORT.minimal"" valueType=""enumerated""/>")
        ...
        PrintLine(1, "")
        PrintLine(1, "GE 423  - Dan Block")
        PrintLine(1, "        Spring(2017)")
        PrintLine(1, "")
        ...
        PrintLine(1, "")
        PrintLine(1, "")
        PrintLine(1, "	Init_UART(9600,1);	// Initialize UART for 9600 baud serial communication")
        PrintLine(1, "")
        ...
        PrintLine(1, "		}")
        PrintLine(1, "")
        PrintLine(1, "		if (newprint)  {")
        PrintLine(1, "")
        PrintLine(1, "			P1OUT ^= 0x1;		// Blink LED")
        PrintLine(1, "")
        PrintLine(1, "			UART_printf(""Hello %d\n\r"",timecnt/2); // divide by two so displays seconds by default")
        PrintLine(1, "")
        ...
        PrintLine(1, "")
        PrintLine(1, "	if (timecheck == 500) {")
        PrintLine(1, "	    timecheck = 0;")
        PrintLine(1, "	    timecnt++;")
        PrintLine(1, "	    newprint = 1;  // flag main while loop that .5 seconds have gone by.  ")
        PrintLine(1, "	}")
        PrintLine(1, "")
        PrintLine(1, "}")
        PrintLine(1, "")
